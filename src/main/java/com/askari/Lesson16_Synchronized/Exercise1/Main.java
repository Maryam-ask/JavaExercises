package com.askari.Lesson16_Synchronized.Exercise1;

import com.askari.Lesson15_THREAD.LessonB.ProcessThread;
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        com.askari.Lesson15_THREAD.LessonB.ProcessThread processThread = new ProcessThread();
